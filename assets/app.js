...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (user && signinBtn && userArea) {
    ...
    if (avatar) {
      if (user.photoURL) {
        const _dn0 = escHTML((user.displayName||'U')[0]);
        avatar.innerHTML = `<img src="${escHTML(user.photoURL)}" alt="${_dn0}" style="width:32px;height:32px;border-radius:50%;object-fit:cover;display:block" onerror="this.parentElement.textContent=this.alt">`;
...
const DOM_TRANSLATIONS = {
  ...
  '(optional)': '(ikhtiyaari)',
  '/ 5 photos': '/ 5 sawir',
  '24h Support': 'Taageero 24 Saac',
  '66% Complete': '66% La Dhammaystiray',
  'About': 'Nagu Saabsan',
  'About Us': 'Nagu Saabsan',
  'Account Scheduled for Deletion': 'Xisaabka Tirtirka Loo Qorsheeyay',
  'Active': 'Firfircoon',
  'Active Ads': 'Xayeysiisyada Firfircoon',
  'Active Listings': 'Liisaska Firfircoon',
  'Active until —': 'Firfircoon ilaa —',
  'Add an extra layer of security to your account.': 'Amaanka xisaabkaaga kor u qaad.',
  'Admin': 'Maamulaha',
  'Advertise': 'Xayeysiis',
  'Affiliate Program': 'Barnaamijka Xulafada',
  'Agency': 'Wakaaladda',
  'All Categories': 'Dhammaan Qaybaha',
  'All Cities': 'Dhammaan Magaalooyinka',
  'All Items': 'Dhammaan Alaabada',
  'All listings are reviewed by our moderation team to ensure a safe marketplace for everyone.': 'Dhammaan xayeysiisyada kooxdeena ayaa dib u eegta si suuq ammaan loogu sameeyo.',
  'Always arrange meetings in crowded public places for your safety.': 'Had iyo jeer kulamo ku samee meelo dadweyne buuxa si amaan u tahaay.',
  'Always communicate within SomBazar for protection.': 'Had iyo jeer SomBazar gudaheeda xiriir u samee ilaalintiisa.',
  'Archive Chat': 'Wadahadalkii Kaydso',
  'Are refunds available?': 'Ma la heli karaa lacag celin?',
  'Are there any hidden transaction fees?': 'Ma jiraan kharash qarsoon oo macaamelateed?',
  'Available codes — click to apply': 'Koodhadda la heli karo — guji si aad u codsato',
  'Basic Information': 'Macluumaadka Aasaasiga ah',
  'Be suspicious of prices too low': 'Ka shakiso qiimaha aad u hooseeya',
  'Be the first to post in this category!': 'Noqo kii ugu horeeyay ee qaybtan ku shidaya!',
  'Berbera': 'Berbera',
  'Block User': 'Isticmaalaha Xannibo',
  'Boost credits included monthly': 'Krediitiyada kordhinta bishiiba waa lagu darayaa',
  'Boost your listings to the top': 'Liisaskaaga kor u qaad',
  'Borama': 'Boorama',
  'Browse': 'Raadso',
  'Browse listings →': 'Liisaska raadso →',
  'Burco': 'Burco',
  'Buyers can make offers on this listing': 'Iibsadayaashu waxay dalad ka samayn karaan liiskan',
  'Buyers prefer local pick-up. An accurate location helps your item sell faster.': 'Iibsadayaashu waxay doorbidaan qaadashada maxalliga ah. Goob sax ah ayaa alaabadaada si deg deg ah u iibisa.',
  'Buying': 'Iibsashada',
  'By clicking you agree to SomBazar\'s': 'Gujinaynta waxaad ogolaanaysaa SomBazar-ka',
  'CHANGE PASSWORD': 'FURAHA BEDEL',
  'Can I change my plan at any time?': 'Ma baddeli karaa qorshahaygii waqti kasta?',
  'Cancel': 'Jooji',
  'Cancel Deletion': 'Tirtirka Jooji',
  'Cancel subscription': 'Rukunka jooji',
  'Card Details': 'Faahfaahinta Kaarka',
  'Card Number': 'Lambarka Kaarka',
  'Cardholder Name': 'Magaca Haysaha Kaarka',
  'Careers': 'Shaqooyin',
  'Cars': 'Baabuurta',
  'Cars & Vehicles': 'Baabuurta iyo Gaadiidka',
  'Cars &amp; Vehicles': 'Baabuurta iyo Gaadiidka',
  'Categories': 'Qaybaha',
  'Category': 'Qaybta',
  'Category, condition & location': 'Qaybta, xaaladda & goobta',
  'Category, condition &amp; location': 'Qaybta, xaaladda & goobta',
  'Ceerigaavo': 'Ceerigaavo',
  'Changes saved!': 'Isbedeladii waa la badbaadiyay!',
  'Check documentation thoroughly': 'Dukumeentiyada si fiican u hubi',
  'Check seller\'s verification badge': 'Astaan xaqiijinta iibiyaha hubi',
  'Check your listing before publishing.': 'Liisaskaaga hubi kahor inta aadan daabicin.',
  'Choose what you want to be notified about.': 'Dooro waxa aad ogeysiis u rabto.',
  'Cities': 'Magaalooyinka',
  'City': 'Magaalada',
  'City *': 'Magaalada *',
  'Clear': 'Nadiifi',
  'Click or drag · JPG, PNG · Max 5MB': 'Guji ama jiid · JPG, PNG · Ugu badan 5MB',
  'Click to zoom': 'Guji si aad u xoogayso',
  'Coming soon': 'Dhawaan ayay timaanaysaa',
  'Commercial Land': 'Dhul Ganacsiga',
  'Company': 'Shirkadda',
  'Compare Features': 'Astaamaha Barbarbar Dhig',
  'Condition': 'Xaaladda',
  'Confidence': 'Kalsoonida',
  'Confirmation': 'Xaqiijinta',
  'Connect with buyers and sellers across Somaliland.': 'Iibiyeyaasha iyo iibsadayaasha Somaliland ku xidh.',
  'Contact': 'La Xiriir',
  'Contact Information': 'Macluumaadka Xiriirka',
  'Contact Support': 'Taageerada La Xiriir',
  'Contact our Support Team': 'Kooxda Taageerada La Xiriir',
  'Contact our support team for any issues regarding this listing.': 'Kooxda taageerada la xiriir arrin kasta oo ku saabsan liiskan.',
  'Continue where you left off': 'Halka aad ka joogsatay ka sii wad',
  'Copy': 'Koobiyee',
  'Copy Link': 'Xiriirka Koobiyee',
  'Create Account': 'Xisaab Abuuri',
  'Create a free account to reach thousands of buyers.': 'Xisaab bilaash ah abuur si aad kumanaan iibsade u gaarto.',
  'Create an account or sign in to manage your listings.': 'Xisaab abuur ama gal si aad liisaskaaga u maamusho.',
  'Create one free': 'Mid bilaash ah abuur',
  'Created': 'La Abuuray',
  'Currency': 'Lacagta',
  'Dahabshiil': 'Dahabshiil',
  'Delete': 'Tirtir',
  'Delete Account?': 'Xisaabka Ma Tirtirsaa?',
  'Delete Forever': 'Weligiis Tirtir',
  'Delete Listing?': 'Liisaska Ma Tirtirsaa?',
  'Delete My Account': 'Xisaabkayga Tirtir',
  'Description': 'Sharaxaadda',
  'Detailed Specs': 'Faahfaahin Sharaxaad',
  'Details': 'Faahfaahinta',
  'Discount': 'Dhimista',
  'Dismiss': 'Iska Dhiib',
  'District (Optional)': 'Degmada (Ikhtiyaari)',
  'Dive deep into the specifics of each plan level.': 'Heerarka qorshe kasta si qoto dheer u baadh.',
  'Don\'t pay anything before inspection': 'Wax ha bixin kahor inta aadan baaraan',
  'Drag and drop photos here': 'Sawirada halkan jiid oo sii daaya',
  'Earn commission by referring new users to SomBazar. Share your unique link and get paid for every successful plan purchase.': 'Astaan kuu gaar ah wadaag oo lacag ka hel qof kasta oo adiga kula xidha.',
  'Easily send and receive counter-offers in real-time.': 'Si fudud u dir oo u qaado dalabyada ka-hortagga ah wakhtiga dhabta ah.',
  'Edit': 'Wax ka Beddel',
  'Edit Listing': 'Liisaska Wax ka Beddel',
  'Edit Listing — SomBazar': 'Liisaska Wax ka Beddel — SomBazar',
  'Electronics': 'Elektaroonigga',
  'Email Address': 'Cinwaanka Emailka',
  'Email Notifications': 'Ogeysiisyada Emailka',
  'Enable push': 'Carruurtooyinka fur',
  'English': 'Ingiriisi',
  'Enter current password': 'Furaha hadda jira geli',
  'Enter new password': 'Furaha cusub geli',
  'Error loading listings': 'Khalad liisaska raraya',
  'Expires': 'Waqtigiisii Dhammaaday',
  'FAQ': 'Su\'aalaha Badanaa La Weydiiyo',
  'FAQ & Help': 'Su\'aalaha & Caawinaadda',
  'Fashion': 'Moodada',
  'Fast, reliable, and secure.': 'Deg deg, aamin, oo ammaan.',
  'Feature not available on your plan.': 'Astaamahan qorshahaaga kuma jirto.',
  'Featured Listings': 'Liisaska Calaamadeysan',
  'Favorites': 'Jecelayaashayda',
  'Find exactly what you need': 'Sida saxda ah waxa aad u baahan tahay ku hel',
  'Find exactly what you need in our curated sections': 'Sida saxda ah waxa aad u baahan tahay qaybaheena ku hel',
  'Fixed Price': 'Qiime Go\'an',
  'For Rent': 'Kiro',
  'For Sale': 'Iibinta',
  'Free': 'Bilaash',
  'Free Trial': 'Tijaabo Bilaash ah',
  ...
  'Guides': 'Hagayaasha',
  'Hargeisa': 'Hargeysa',
  'Help Center': 'Xarunta Caawinaadda',
  'High to Low': 'Sare ilaa Hoose',
  'Hotels': 'Huteelada',
  'Houses': 'Guryaha',
  'Houses & Apartments': 'Guryaha iyo Dabaqyada',
  'How do I make an offer?': 'Sideen dalad u sameeyaa?',
  'How do I post a listing?': 'Sideen xayeysiis u shidaa?',
  'How does payment work?': 'Lacag bixintu sidee u shaqeysaa?',
  'ID Verification': 'Xaqiijinta Aqoonsiga',
  'Images': 'Sawirrada',
  'In Escrow': 'Dhawrka',
  'Inspect the item thoroughly before making any payment or commitment.': 'Shayga si fiican u baadh kahor lacag bixin ama ballan qaadasho.',
  'Integrations': 'Isku-xidhidda',
  'Is it safe to buy online?': 'Ma ammaan tahay iibsashada onlaynka?',
  'Jobs': 'Shaqooyin',
  'Land': 'Dhulka',
  'Language': 'Luqadda',
  'Last seen': 'Markii dambe la arkay',
  'Listing': 'Liisaska',
  'Listing Details': 'Faahfaahinta Liisaska',
  'Listing successfully published!': 'Liisaska si guul leh ayaa loo daabicay!',
  'Listings': 'Liisaska',
  'Loading...': 'Waa la rarayo...',
  'Location': 'Goobta',
  'Log In': 'Gal',
  'Login': 'Gal',
  'Low to High': 'Hoose ilaa Sare',
  'Make Offer': 'Dalad Samee',
  'Make an Offer': 'Dalad Samee',
  'Manage Subscription →': 'Rukunka Maamul →',
  'Mark as Sold': 'Iibsan u Calaamadee',
  'Maximum photos': 'Sawirada ugu badan',
  'Meet in a safe, public location': 'Meel ammaan oo dadweyne ah ku kulmid',
  'Meet in Public': 'Dadweynaha Ku Kulmid',
  'Member since': 'Xubinnimada laga bilaabay',
  'Message': 'Farriinta',
  'Messages': 'Farriimaha',
  'My Listings': 'Xayeysiisyadayda',
  'My Profile': 'Xogaygii',
  'My Reviews': 'Faalloadaydii',
  'Negotiable': 'Wax Laga Xukumi Karo',
  'New': 'Cusub',
  'New Listings': 'Liisaska Cusub',
  'New Message': 'Fariin Cusub',
  'New Password': 'Furaha Cusub',
  'Newsletter': 'Wargeysyada',
  'Next': 'Xiga',
  'No': 'Maya',
  'No listings found': 'Liisas lama helin',
  'No messages': 'Fariin ma jirto',
  'No messages yet': 'Wali fariin ma jirto',
  'No messages yet. Start a conversation!': 'Wali fariin ma jirto. Wadahadal bilow!',
  'No new notifications': 'Ogeysiis cusub ma jiro',
  'No offers yet': 'Wali dalad ma jirto',
  'No results found': 'Wax la helay ma jiraan',
  'Notifications': 'Ogeysiisyada',
  'Offer': 'Dalad',
  'Offer Accepted': 'Daladdii Waa La Aqbalay',
  'Offer Declined': 'Daladdii Waa La Diidday',
  'Offers': 'Dalabyada',
  'Offers Received': 'Dalabyada La Helay',
  'Online': 'Onlayn',
  'Optional': 'Ikhtiyaari',
  'Or': 'Ama',
  'Password': 'Furaha Sirta',
  'Password must be at least 6 characters': 'Furaha sirta waa inuu ahaadaa ugu yaraan 6 xaraf',
  'Payments & Billing': 'Lacag Bixinta',
  'Pending': 'Sugaya',
  'Pending Review': 'Dib u Eegista Sugaya',
  'Phone': 'Telefoonka',
  'Phone Number': 'Lambarka Telefoonka',
  'Photos': 'Sawirrada',
  'Post Ad': 'Xayeysiis Shid',
  'Post Free Ad': 'Xayeysiis Bilaash ah Shid',
  'Post New Ad': 'Xayeysiis Cusub Shid',
  'Post a Free Ad': 'Xayeysiis Bilaash ah Shid',
  'Post a New Ad': 'Xayeysiis Cusub Shid',
  'Premium Membership': 'Xubinnimada Premium-ka',
  'Price': 'Qiimaha',
  'Price & Location': 'Qiimaha & Goobta',
  'Price Negotiable': 'Qiimaha Wax Laga Xukumi Karo',
  'Price Range': 'Xadka Qiimaha',
  'Price: High to Low': 'Qiimaha: Sare ilaa Hoose',
  'Price: Low to High': 'Qiimaha: Hoose ilaa Sare',
  'Privacy Policy': 'Siyaasadda Xumaasnimada',
  'Pro': 'Xirfadlaha',
  'Profile': 'Xogta',
  'Publish Listing': 'Liisaska Daabic',
  'Quick Links': 'Xiriiriyeyaasha Degdegga ah',
  'Rating': 'Qiimaynta',
  'Real Estate': 'Hantida',
  'Recent Listings': 'Liisaska Dhowaan',
  'Reject': 'Diid',
  'Rejected': 'La Diidday',
  'Related Listings': 'Liisaska La Xiriira',
  'Relist': 'Dib u Liis',
  'Remove': 'Ka Saar',
  'Report': 'Warbixin',
  'Report this ad →': 'Xayeysiiskan Warbixin →',
  'Report this listing': 'Liiskan Warbixin',
  'Reset Password': 'Furaha Dib u Deji',
  'Reviews': 'Faalladaha',
  'Safety Tips': 'Talooyin Amaan',
  'Save': 'Kaydi',
  'Save Changes': 'Isbedelada Kaydi',
  'Search': 'Raadi',
  'Search conversations...': 'Wadahadalada raadi...',
  'Search listings...': 'Liisaska raadi...',
  'Security': 'Amaanka',
  'See All': 'Dhammaan Arag',
  'See All Listings': 'Dhammaan Liisaska Arag',
  'See All Listings →': 'Dhammaan Liisaska Arag →',
  'Sell': 'Iibso',
  'Sell Something?': 'Ma Waxba Iibinaysaa?',
  'Seller': 'Iibiyaha',
  'Send Message': 'Farriinta Dir',
  'Send Reset Email': 'Emailka Dib-u-Dejinta Dir',
  'Services': 'Adeegyada',
  'Settings': 'Goobaha',
  'Share': 'La wadaag',
  'Sign In': 'Gal',
  'Sign Out': 'Ka Bax',
  'Sign Up': 'Diiwaan Geli',
  'Similar Listings': 'Liisaska La Midka ah',
  'SMS Notifications': 'Ogeysiisyada SMS-ka',
  'Sold': 'La Iibiyay',
  'Somali': 'Soomaali',
  'Somaliland': 'Somaliland',
  'Somaliland\'s Largest Online Marketplace': 'Suuqga Onlaynka Ugu Weyn ee Somaliland',
  'Sort by': 'Kala Sooc',
  'Sort: Newest First': 'Kala Sooc: Cusub Hore',
  'Standard': 'Caadiga',
  'Start Chat': 'Wadahadal Bilow',
  'Status': 'Xaaladda',
  'Subscribe': 'Qabso',
  'Subscribed!': 'Waa la Qabsaday!',
  'Take a friend along for inspection': 'Saaxiib u kaxee baaraan',
  'Terms': 'Shuruudaha',
  'Terms of Service': 'Shuruudaha Adeegga',
  'Title': 'Cinwaanka',
  'Title *': 'Cinwaanka *',
  'Today\'s Deals': 'Heshiisyada Maanta',
  'Top Sellers': 'Iibiyeyaasha Ugu Wanaagsan',
  'Trade Safely on SomBazar': 'Si Ammaan ah ugu Ganacsado SomBazar',
  'Type': 'Nooca',
  'Type a message...': 'Fariin geli...',
  'USD': 'USD',
  'Unread': 'La Aqrinin',
  'Update Password': 'Furaha Cusboonaysii',
  'Upload Photos': 'Sawirrada Kor u Geli',
  'Used': 'La Isticmaalay',
  'User not found': 'Isticmaalaha lama helin',
  'Verified': 'La Xaqiijiyay',
  'Verify First': 'Marka Hore Xaqiiji',
  ...
  'Yes': 'Haa',
  'Your listing has been submitted for review.': 'Liisaskaaga dib u eegista ayaa loo gudbiyay.',
  'Your plan': 'Qorshahaaga',
  'Your security is our priority.': 'Ammaankaagu waa mudnaanteena.',
  'Your security is our priority. Follow these simple steps.': 'Ammaankaagu waa mudnaanteena. Tallaabadahan fudud raac.',
  'all': 'Dhammaan',
  'car': 'Baabuurta',
  'electronics': 'Elektaroonigga',
  'fashion': 'Moodada',
  ...
  'land': 'Dhulka',
  'services': 'Adeegyada',
  'Automotive': 'Baabuurta',
  'Phones & Tablets': 'Taleefannada & Tablets',
  'No Pre-payments': 'Lacag Hore Lama Bixin',
  'Never pay for an item before receiving and checking it in person.': 'Waligiis shay ha u bixin kahor inta aadan qaadan oo aadan midaad ka sameynin.',
  'Get Notified': 'Ogeysiis Hel',
  'Subscribe to get the latest listings and deals.': 'Liisaska iyo heshiisyada ugu dambe hel.',
  'Enter your email': 'Emailkaaga geli',
  'Explore Categories': 'Qaybaha Raadso',
};
...
function applyLang(lang) {
  ...
  // DOM text node traversal — translate ALL visible text
  if (lang === 'so') {
    _translateDOM(document.body, DOM_TRANSLATIONS, false);
  } else {
    // Reload page to restore English (simplest, avoids reverse-mapping issues)
    // But only if we were in Somali before
    if (document.body.getAttribute('data-lang-applied') === 'so') {
      location.reload();
      return;
    }
  }
  document.body.setAttribute('data-lang-applied', lang);
  window._lang = lang;
}

function _translateDOM(root, dict, restore) {
  // Walk all text nodes and translate known strings
  ...
  root.querySelectorAll('[placeholder]').forEach(el => {
    ...
    if (dict[orig]) el.setAttribute('placeholder', dict[orig]);
  });
